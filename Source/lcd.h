...
sbit LCD_RW=P2^1;//khai bao chan RW cua LCD o P2.1
sbit LCD_EN=P2^2;//khai bao chan EN cua LCD o P2.2

sbit LCD_D4=P2^4;//khai bao chan D4 cua LCD o P0.4
sbit LCD_D5=P2^5;//khai bao chan D4 cua LCD o P0.5
sbit LCD_D6=P2^6;//khai bao chan D4 cua LCD o P0.6
sbit LCD_D7=P2^7;//khai bao chan D4 cua LCD o P0.7
